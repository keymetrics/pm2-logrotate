...
var COMPRESSION = conf.compress ? JSON.parse(conf.compress) : false; // Do not compress by default
var DATE_FORMAT = conf.dateFormat || 'YYYY-MM-DD_HH-mm-ss';
var TZ = conf.TZ;
var ROTATE_MODULE = conf.rotateModule ? JSON.parse(conf.rotateModule) : true;
var WATCHED_FILES = [];
